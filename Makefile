...
coverage: ## check code coverage quickly with the default Python
	coverage run --source somos_kudasai setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/somos_kudasai.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ somos_kudasai
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pycodestyle --statistics somos_kudasai tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes somos_kudasai tests
